...
import { o as __toESM$1 } from "./inputNotify-DBpkbcIo.js";
import { t as require_react } from "./react-DR7gtnlh.js";
import { t as require_server_node } from "./server.node-DN4ZySii.js";
...
const importTsModule = async (filePath) => {
	if (!registered) {
		const { register } = await import("./api-DVTbj5ZO.js");
		register();
		registered = true;
	}
